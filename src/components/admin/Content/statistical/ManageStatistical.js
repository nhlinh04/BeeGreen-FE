    ...
    switch (view) {
      case "day":
        return statistics.filter(
          (stat) =>
            new Date(stat.createdAt).toDateString() === today.toDateString()
        );
      case "month":
        return statistics.filter(
          (stat) =>
        ...
        <div className="manage-cart-container">
                  ...
                  <tbody>
                    {currentItems1 && currentItems1.length > 0 ? (
                      currentItems1.map((item, index) => (
                        <tr key={index}>
                          <td>
                            {index + 1 + (currentPage1 - 1) * itemsPerPage}
                          </td>
                          <td>
          ...
          <div className="row m-3">
            <div className="col-lg-6 col-md-12">
              <div className="info-item row align-items-center bg-white rounded p-3 shadow-sm m-2">
                ...
                <div className="col">
                  ...
                  <p className="m-0 fs-4 ps-4">{accounts.length}</p>
            ...
            <div className="col-lg-6 col-md-12">
              ...
              <div className="bg-white rounded p-3 shadow-sm m-2">
                <div>
                  <h5>Doanh thu sản phẩm được bán nhiều nhất</h5>
                </div>
                <div className="table-product mb-3">
                  <Table striped bordered hover className="align-middle">
                    <thead>
                      ...
                      {currentItems2 && currentItems2.length > 0 ? (
                        currentItems2.map((item, index) => (
                          <tr key={item.id || index}>
                            <td>
                              {index + 1 + (currentPage2 - 1) * itemsPerPage}
                            </td>
                            <td>
                              <ListImageProduct
                                id={item?.idProduct}
                  ...
                  <div className="d-flex justify-content-center">
                    <Pagination>
                      ...
                      />
                      <Pagination.Last
                        onClick={() => handlePageChange2(totalPages2)}
                        disabled={currentPage2 === totalPages2}
                      />
                    </Pagination>
                  </div>
                ...
                <ResponsiveContainer width="100%" height={400}>
                  ...
                  >
                    ...
                    <XAxis
                      ...
                      tickFormatter={(tick) =>
                        format(new Date(tick), "dd/MM/yyyy")
                      } // Định dạng ngày
                    />
                    <YAxis
